...
// Context - makes sure that a process which launches a whole lot of goroutines
// If you cancel that process, it should cancel all of the launched goroutines as well
// Prevents from goroutines leaking out
